...
const SiteHeader = ({tagline}:Props) => {
  const [navTriggerActive, setNavTriggerActive] = useState<boolean>(false);
  const [logoMarkup, setLogoMarkup] = useState<boolean>(true);
  ...
  return (
    <header role="banner" className='site-header'>
      <a href="#main" className="focusable">Skip to main content</a>
      <div className="svg-legend" aria-hidden="true">
          <svg focusable="false" version="1.1" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" >
              <symbol id="icon-corgi" fill="#000000" viewBox="0 0 472.566 472.566">
      ...
      <div className="header-container">
          <SiteLogo
            // handleLogoMarkup={handleLogoMarkup}
             tagline={tagline}

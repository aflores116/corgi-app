    ...
    <>
      <nav className="site-header-nav" role="navigation">
        <button
          className={
            !navTriggerActive
              ...
              : "site-header-nav__trigger site-header-nav__trigger--active"
          }
        ...
        <span className="focusable" tabIndex={0}>
          Navigation Instructions: Press tab to navigate to the next menu item,
          and hit enter to go to that page.
        </span>
        <ul
          className={
            !navTriggerActive
              ? "site-nav-listing"
              : "site-nav-listing site-nav-listing--active"
          }
        >
          ...
          <li className="site-nav-listing__item">
            <Link className="site-nav-listing__item-link" to="/corgi-app/about">
              About Corgis
            </Link>
          </li>
          <li className="site-nav-listing__item">
